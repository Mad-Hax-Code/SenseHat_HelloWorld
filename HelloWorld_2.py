...
# Below we create a String variable called textToDisplay (a variable that is considered text)
# We also assign the value of Hello World to that String variable
textToDisplay = "Hello World"

# Create a tuple in the format Red, Green, Blue (RGB)
# The following puts no values in Red or Green, but puts a full value in the Blue section.
